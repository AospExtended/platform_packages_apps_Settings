...
public abstract class FingerprintEnrollBase extends InstrumentedActivity
    ...
    protected boolean mHasBottomSensor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHasBottomSensor = getResources().getBoolean(R.bool.config_hasBottomFingerprintSensor);
        mNavBarEnabled = Settings.Secure.getIntForUser(this.getContentResolver(),
                        Settings.Secure.NAVIGATION_BAR_VISIBLE, DUActionUtils.hasNavbarByDefault(this) ? 1 : 0, UserHandle.USER_CURRENT) != 0;
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (mHasBottomSensor && mWasUsingNavbar) {
            disableNavbar(false);
        }
    }

    protected void disableNavbar(boolean disabled) {
        Settings.Secure.putInt(this.getContentResolver(),
                Settings.Secure.NAVIGATION_BAR_VISIBLE, disabled ? 0 : 1);
    }
