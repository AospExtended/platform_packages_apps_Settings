...
public class Themes extends SettingsPreferenceFragment implements
        ...
        if (preference == mThemeSwitch) {
            ...
            switch (theme_switch) {
                case "1":
                    ...
                    handleBackgrounds(false, context, UiModeManager.MODE_NIGHT_NO, ThemesUtils.EXTENDED_UI);
                    break;
                case "2":
                    handleBackgrounds(false, context, UiModeManager.MODE_NIGHT_YES, ThemesUtils.PITCH_BLACK);
                    handleBackgrounds(false, context, UiModeManager.MODE_NIGHT_YES, ThemesUtils.EXTENDED_UI);
                    break;
                case "3":
                ...
                case "4":
                    handleBackgrounds(false, context, UiModeManager.MODE_NIGHT_YES, ThemesUtils.PITCH_BLACK);
                    handleBackgrounds(true, context, UiModeManager.MODE_NIGHT_YES, ThemesUtils.EXTENDED_UI);
                    break;
            }
        }
        return true;
    ...
    private void setupThemeSwitchPref() {
        ...
        if (AEXUtils.isThemeEnabled("com.android.theme.extendedui.system")) {
            mThemeSwitch.setValue("4");
        } else if (AEXUtils.isThemeEnabled("com.android.theme.pitchblack.system")) {
