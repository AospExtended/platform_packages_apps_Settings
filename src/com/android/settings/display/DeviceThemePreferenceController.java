...
import com.android.settings.display.DeviceThemePreferenceSettings;
...
public class DeviceThemePreferenceController extends AbstractPreferenceController implements
    ...
    private DeviceThemePreferenceSettings mThemeSettings;
    ...
    public DeviceThemePreferenceController(Context context) {
        ...
        mThemeSettings = new DeviceThemePreferenceSettings(context);
    }
        ...
        if (preference.getKey() == getPreferenceKey()) {
            final boolean dialogSeen =
                    Settings.Secure.getInt(mContext.getContentResolver(),
                        Settings.Secure.DARK_MODE_DIALOG_SEEN, 0) == 1;
			if (!dialogSeen) showThemeHelp();
			return true;
        }
		return false;
    }
