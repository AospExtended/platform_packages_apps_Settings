...
public class DarkThemeVariantPreferenceController extends AbstractPreferenceController implements
        PreferenceControllerMixin, Preference.OnPreferenceChangeListener, LifecycleObserver, OnResume {

    private static final String SYSTEM_DARK_THEME_STYLE = "system_dark_theme_style";
    private ListPreference mSystemThemeStyle;

    public DarkThemeVariantPreferenceController(Context context, Lifecycle lifecycle, Fragment parent) {
        super(context);
        if (lifecycle != null) {
    ...
    public String getPreferenceKey() {
        return SYSTEM_DARK_THEME_STYLE;
    }
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        mSystemThemeStyle = (ListPreference) screen.findPreference(SYSTEM_DARK_THEME_STYLE);
        updateState();
    }
    ...
    public void updateState() {
        if (!isSubstratumOverlayInstalled(mContext) || isForceThemeAllowed()) {
            int systemThemeStyle = Settings.System.getInt(mContext.getContentResolver(),
                    Settings.System.SYSTEM_DARK_THEME_STYLE, 0);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mSystemThemeStyle) {
            ...
            Settings.System.putInt(mContext.getContentResolver(), Settings.System.SYSTEM_DARK_THEME_STYLE, Integer.valueOf(value));
