...
PreferenceControllerMixin, Preference.OnPreferenceChangeListener {
    ...
    public ForceAllowThemePreferenceController(Context context, DarkUIPreferenceController uiStylePreference, AccentPickerPreferenceController accentPickerPreference, FontPickerPreferenceController fontPickerPreference) {
        super(context);
        mUIStylePreference = uiStylePreference;
        mAccentPickerPreference = accentPickerPreference;
        mFontPickerPreference = fontPickerPreference;
    }
