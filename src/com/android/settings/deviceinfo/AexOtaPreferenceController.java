...
public class AexOtaPreferenceController extends PreferenceController {
    ...
    public boolean isAvailable() {
     ...
     if (Utils.isPackageInstalled(getActivity(), KEY_AEXOTA_PACKAGE_NAME) && buildtype.equalsIgnoreCase("official")) {
