...
public class CustomDialogPreferenceLOS<T extends DialogInterface> extends DialogPreference {

    private CustomPreferenceDialogFragment mFragment;

    public CustomDialogPreferenceLOS(Context context, AttributeSet attrs, int defStyleAttr,
            int defStyleRes) {
    ...
    public CustomDialogPreferenceLOS(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomDialogPreferenceLOS(Context context) {
        super(context);
    }
    ...
    public static class CustomPreferenceDialogFragment extends PreferenceDialogFragment {
        ...
        private CustomDialogPreferenceLOS getCustomizablePreference() {
            return (CustomDialogPreferenceLOS) getPreference();
        }
