...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
    ...
    protected void refreshUi(@BatteryUpdateType int refreshType) {
        ...
        mBatteryTemp.setSubtitle(
                com.android.internal.util.aospextended.AEXUtils.mccCheck(getContext()) ?
                com.android.internal.util.aospextended.AEXUtils.batteryTemperature(getContext(), true) + "°F" :
                com.android.internal.util.aospextended.AEXUtils.batteryTemperature(getContext(), false) + "°C");
    }
